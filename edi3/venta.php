...
$record = $conn->prepare('SELECT * FROM inmuebles where vender = 1');
$record->execute();
...
<html>
  ...
  <body">
          ...
          <img src="img/logo2.jpg" class="avatar" alt="Avatar Image">
            ...
            <div id="menu">
              <ul>
                ...
                <li><a href="/edi/venta.php" class="active_now"><span class="	fas fa-award"></span> VENTA</a></li>
    ...
    <?php
      ...
      $sql_Inmuebles = $conn->prepare('SELECT * FROM inmuebles where vender = 1 LIMIT :iniciar , :nInmuebles ');
    ...
    <div class="container-pag">
      <ul class="pagination">
        <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled':''  ?>">
          <a class="page-link" href="venta.php?pagina=<?php echo $_GET['pagina']-1 ?>">
            Anterior
          </a>
        </li>
        ...
        <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
          <a class="page-link" href="venta.php?pagina=<?php echo $i+1 ?>"> <?php echo $i+1 ?></a>
        </li>
        ...
        <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled':''  ?>">
          <a class="page-link" href="venta.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente</a>
        </li>
      </ul>
    </div>
